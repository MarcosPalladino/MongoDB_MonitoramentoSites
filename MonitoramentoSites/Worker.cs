...
namespace MonitoramentoSites
{
    public class Worker : BackgroundService
    {
        ...
        private IMongoCollection<ResultadoMonitoramento> disponibilidadeCollection;
        ...
        {
            mongoClient = new MongoClient(_configuration.GetConnectionString("BaseMonitoramentoSites"));
            db = mongoClient.GetDatabase("DBMonitoramento");
            disponibilidadeCollection =db.GetCollection<ResultadoMonitoramento>("Disponibilidade");
        ...
        public override Task StopAsync(CancellationToken cancellationToken)
        {
            var dadosLog = new ResultadoMonitoramento()
            {
                ...
                DescricaoErro = "The service has been stopped...",
                Status = "Stopped"
            };
